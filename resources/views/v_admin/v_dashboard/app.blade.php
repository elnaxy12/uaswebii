...
<head>
    ...
    <title>Welcome To Dashboard | Admin</title>
</head>

<body class="bg-gray-100">
    <!-- start navbar -->
    <div
        class="md:fixed md:w-full md:top-0 md:z-20 container flex flex-row flex-wrap items-center bg-white p-6 border-b border-gray-300">
        <!-- logo -->
            ...
            <div class="flex flex-row-reverse items-center">
                ...
                <div class="dropdown relative md:static">
                    ...
                    <div
                        ...
                        <form action="{{ route('logout') }}" method="POST" class="inline">
                            @csrf
                            <button type="submit"
                                class="px-4 py-2 block capitalize font-medium text-sm tracking-wide bg-white hover:bg-gray-200 hover:text-gray-900 transition-all duration-300 ease-in-out w-full text-left">
                ...
                <div class="dropdown relative mr-5 md:static">
                    ...
                    <div
                        ...
                        <!-- top -->
                        <div
                            class="px-4 py-2 flex flex-row justify-between items-center capitalize font-semibold text-xs">
                            <h1>notifications</h1>
    ...
    <div class="h-screen w-full flex flex-row flex-wrap">
        ...
        <div class="bg-gray-100 flex-1 p-6 md:mt-16">
            ...
            <div class="mt-6 grid grid-cols-2 gap-6 xl:grid-cols-1">
                ...
                <!-- update section -->
                <div class="card element border-teal-400 shadow-md text-white">
                    <div class="card-body flex flex-row">
                        ...
                        <div class="py-2 ml-10">
                            <h1 class="h6">Good Job, Cleopatra!</h1>
                ...
                <div class="flex flex-col">
                    ...
                    <div class="alert alert-dark mb-6">
                        {{ $admin->name }}, Welcome to our Dashboard!!
                    ...
                    <div class="grid grid-cols-2 gap-6 h-full">
                        ...
                        <div class="card">
                            <div class="py-3 px-4 flex flex-row justify-between h-fit">
                                <h1 class="h6">
            ...
            <!-- start numbers -->
            <div class="grid grid-cols-5 gap-5 xl:grid-cols-2">
                <!-- card 1 -->
                ...
                <div class="card mt-6 xl:mt-0">
                    <div class="card-body flex items-center">
                        ...
                        <div class="flex flex-col">
                            <h1 class="font-semibold text-xs"><span class="num-2"></span> Comments</h1>
                ...
                <!-- card 5 -->
                <div class="card mt-6 xl:mt-0 xl:col-span-2">
                    <div class="card-body flex items-center">
