<div class="md:pt-[12rem] pt-[4rem] w-3xs">
    <div class="flex w-full flex-col gap-3 mt-10 pl-5">
        ...
        <div class="flex flex-col justify-start gap-1">
            ...
            <a href="{{ route('user.order') }}" class="hover:text-black/80! transition-all duration-100 hover:border-b-black hover:bg-gray-100 focus:border-b-black border-b-white border-b-1 cursor-pointer">My Order</a>
